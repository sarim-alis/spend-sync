...
export default StyleSheet.create({
  ...
  slogan: { alignSelf: "center", marginBottom: 5, marginTop: 10, fontSize: 24, fontWeight: "800", color: "pink"},
  label: { alignSelf: "flex-start", marginBottom: 5, marginTop: 10, fontSize: 14, fontWeight: "500", color: "#333", fontWeight: "700"},
  inputWrapper: { width: "100%", position: "relative", marginBottom: 15},
  eyeIcon: { position: "absolute", right: 20, top: "55%", transform: [{ translateY: -20 }], zIndex: 1},
  ...
  switchTexts: { fontWeight: "900", color: "pink"},
